...
**Date:** 2026-05-02
**Status:** Draft (post-Jarvis-Studio pivot) · **v1.0 scope-reduced 2026-05-02 after Critic round-2** (see §15 D12) · **Revision 2026-06-12/13: live transcription + live chat with tools accepted for v1.x; speaker echo cancellation added and then moved from VPIO to custom DSP** (see §15 D17–D22)
